...
- Use accurate, standard Romanian culinary vocabulary. Watch for false friends and near-miss loanwords — always use the correct Romanian form, never a French/English spelling with the diacritics dropped or swapped: "poached" is "poșat" (ouă poșate), never "pochat"/"poșat" without the ș or any French-spelled variant; "noodles" is "tăiței" or "paste", never "noduri"; "bell pepper" is "ardei gras" (or "gogoșar"), never "paprika"/"paprica" (that's the spice); "toothpick" is "scobitoare", never "cărucior"; "sour cream" is "smântână", never invented terms; "sautéed" is "călit" (or "sotat"), never "sautat"; "blanched" is "blanșat", never "blanchat"; "seared" is "rumenit" (foc iute), never left as "seared"; "deglazed" is "deglasat", never "deglazat"; "glazed" is "glasat", never "glazurat" as a verb; "simmered" is "fiert la foc mic" / "lăsat să fiarbă domol", never "simerat"; "whisked" is "bătut (cu telul)", never "whisked" or "wisc-uit"; "folded in" (batter) is "încorporat prin mișcări ușoare", never "foldat".
