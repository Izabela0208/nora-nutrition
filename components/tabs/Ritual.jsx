...
const CHALLENGES_GENERAL = [
  ...
  { id:"g10", title:"Magnesium Before Bed", category:"supplements", difficulty:"Beginner", duration:"2 min", instruction:"Take a magnesium glycinate supplement 30 minutes before bed tonight, following the label's guidance. Use glycinate form - oxide does not effectively cross the blood-brain barrier. Consult your doctor before starting.", science:"Magnesium activates GABA receptors in the brain, reducing neuronal excitability and may support slow-wave sleep depth, per double-blind trials.", pubmedQ:"magnesium sleep quality", pubmedFbs:["magnesium glycinate GABA sleep","magnesium supplement insomnia"] },
  ...
  { id:"g32", title:"Omega-3 with Largest Meal", category:"supplements", difficulty:"Beginner", duration:"2 min", instruction:"Take an EPA + DHA omega-3 supplement with your largest meal today, following the label's guidance. Look for triglyceride-form fish oil or algae-based omega-3. Consult your doctor before starting, especially if on blood thinners.", science:"EPA and DHA incorporate into neuronal membranes within 6-8 weeks, measurably reducing inflammatory cytokines IL-6 and CRP and improving cognitive processing speed in meta-analyses.", pubmedQ:"omega-3 EPA DHA inflammation", pubmedFbs:["fish oil cognitive health","omega 3 cardiovascular"] },
  ...
  { id:"g38", title:"Vitamin D + K2 Protocol", category:"supplements", difficulty:"Beginner", duration:"2 min", instruction:"Take a vitamin D3 with K2 (MK-7) supplement alongside a fat-containing meal today, following the label's guidance. Test 25-OH-D levels before adjusting your intake - consult your doctor. Optimal range is 40-60 ng/mL.", science:"Vitamin D3 acts as a hormone, regulating 2000+ genes. Low levels are common and studies link them to higher all-cause mortality risk and reduced immune function.", pubmedQ:"vitamin D3 supplementation health", pubmedFbs:["vitamin D deficiency immune","D3 K2 outcomes"] },
...
const CHALLENGES_FEMALE = [
  ...
  { id:"f07", bioCat:"cycle", phase:["luteal","menstrual"], title:"PMS Magnesium Protocol", category:"supplements", difficulty:"Beginner", duration:"2 min", instruction:"From day 15 through menstruation, take a magnesium glycinate supplement at bedtime, following the label's guidance. Eat 2 squares of 85%+ dark chocolate daily - a natural source of magnesium that may also help lower cortisol. Consult your doctor.", science:"Low magnesium status is linked to worse PMS symptoms including cramps, mood fluctuations, and breast tenderness. Supplementation may help reduce PMS severity over a few cycles, per clinical trials.", pubmedQ:"magnesium PMS premenstrual syndrome", pubmedFbs:["magnesium PMS women","magnesium menstrual cramps"] },
...
const CHALLENGES_MALE = [
  ...
  { id:"m02", title:"Creatine Daily Protocol", category:"supplements", difficulty:"Beginner", duration:"2 min", instruction:"Take a creatine monohydrate supplement daily with breakfast, following the label's guidance. No loading phase needed. Take every day - not just training days. Effects accumulate over several weeks of consistent use. Consult your doctor first.", science:"Creatine increases phosphocreatine resynthesis, enabling 5-15% more reps at equivalent loads and accelerating neuromuscular recovery. The most studied performance supplement with the strongest safety record.", pubmedQ:"creatine monohydrate performance", pubmedFbs:["creatine supplementation men muscle","creatine cognitive"] },
  { id:"m03", title:"Zinc-Rich Meal", category:"nutrition", difficulty:"Beginner", duration:"All day", instruction:"Eat oysters, red meat, or pumpkin seeds today. Add a handful of pumpkin seeds to lunch. If supplementing zinc, take it at dinner rather than morning - following the label's guidance - since zinc competes with copper for absorption. Consult your doctor.", science:"Zinc is a co-factor in testosterone synthesis. Low zinc status may suppress serum testosterone, and supplementation has been shown to help restore levels in athletes under intense training.", pubmedQ:"zinc testosterone men", pubmedFbs:["zinc deficiency testosterone","zinc supplementation hormones men"] },
  ...
  { id:"m06", title:"Vitamin D for Testosterone", category:"supplements", difficulty:"Beginner", duration:"2 min", instruction:"Take a vitamin D3 + K2 (MK-7) supplement with your largest meal, following the label's guidance. Test 25-OH-D levels first - target 50-70 ng/mL. Consult your doctor before increasing your intake.", science:"Vitamin D receptors are found in Leydig cells (testicular testosterone-producing cells). Studies suggest men with low vitamin D levels tend to have meaningfully lower testosterone than those with optimal levels.", pubmedQ:"vitamin D testosterone men", pubmedFbs:["vitamin D deficiency testosterone","D3 supplementation men"] },
  ...
  { id:"m09", title:"Ashwagandha for Performance", category:"supplements", difficulty:"Beginner", duration:"2 min", instruction:"Take a KSM-66 ashwagandha extract supplement with dinner tonight, following the label's guidance. Take consistently for 8-12 weeks. Consult your doctor before starting, especially if on thyroid medication or sedatives.", science:"KSM-66 ashwagandha has been shown to increase testosterone and reduce cortisol, and may modestly increase VO2max, in double-blind placebo-controlled trials in men.", pubmedQ:"ashwagandha testosterone cortisol men", pubmedFbs:["KSM-66 performance men","ashwagandha strength training"] },
...
const EXPLORE_CATEGORIES = [
  ...
  { id:"supplements",title:"Supplements",         subtitle:"Precision micronutrient support",        colSpan:1, guide:"Three supplements have the strongest evidence base: magnesium glycinate before bed for sleep depth, GABA synthesis, and muscle relaxation; vitamin D3 with K2 for immune, bone, and hormonal function - many adults run low; and omega-3 EPA/DHA for cardiovascular and cognitive health. The right amount is individual - consult your doctor before starting.", protocol:"Magnesium glycinate, 30 min before bed · Vitamin D3+K2 and omega-3: test and consult your doctor" },
